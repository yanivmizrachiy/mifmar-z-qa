const sections = [
  {
    ...
    items: [
      { q: 'ממה מורכב מבחן המפמ״ר במתמטיקה לכיתה ז׳ תשפ״ו?', a: [
      ...
      { q: 'כמה שאלות התלמיד עונה בכל חלק?', a: [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'איך בוחרים את השאלות בחלק הראשון?', a: [
      ...
      { q: 'האם צריך לשנות את הניקוד ב־Moodle לאחר מחיקת שאלות?', a: [
        'לא. אין צורך לשנות את ניקוד השאלות.',
        'הניקוד יחושב אוטומטית מתוך 100, גם לאחר מחיקת השאלות שלא נבחרו.'
      ]},
      { q: 'אם שאלה נמחקה בטעות מהמשימה ב־Moodle, האם אפשר להחזיר אותה?', a: [
      ...
      { q: 'איך פותחים את המבחן לצפייה ולפתרון של התלמידים?', a: [
      ...
      { q: 'מה קורה כאשר התלמיד מגיש את החלק המתוקשב?', a: [
  ...
  },
  {
    ...
    items: [
      { q: 'איפה נמצאים קבצי החלק השני של המבחן?', a: [
      ...
      { q: 'מי בודק את החלק השני וכיצד הוא מנוקד?', a: [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'למי פונים בבקשה לדחיית מועד הבחינה מעבר ל־01.06.2026?', a: [
