const sections = [
  {
    id: 'overview',
    title: 'הרכב המבחן והציון',
    items: [
      {
        q: 'ממה מורכב מבחן המפמ״ר במתמטיקה לכיתה ז׳ תשפ״ו?',
        a: [
          'המבחן מורכב משני חלקים.',
          'חלק ראשון — שאלות מתוקשבות בסביבת Moodle.',
          'חלק שני — שאלות בכתב, המצורפות בקובץ PDF ובקובץ Word.',
          'בשני החלקים יחד התלמיד עונה על 5 שאלות.'
        ]
      },
      {
        q: 'כמה שאלות התלמיד עונה בכל חלק?',
        a: [
          'בחלק הראשון, בסביבת Moodle, התלמיד עונה על 2 שאלות.',
          'בחלק השני, בכתב, התלמיד עונה על 3 שאלות.',
          'בסך הכול התלמיד עונה על 5 שאלות במבחן כולו.'
        ]
      },
      {
        q: 'איך מחושב ציון המבחן?',
        a: [
          'כל אחת מ־5 השאלות מקבלת ציון מתוך 100 נקודות.',
          'בחלק הראשון השאלות נבדקות אוטומטית ב־Moodle, ועל כל שאלה ניתן ציון נפרד.',
          'בחלק השני השאלות נבדקות על ידי המורה באמצעות מחוון שיצורף לקובץ.',
  ...
  {
    id: 'moodle',
    title: 'חלק ראשון — שאלות מתוקשבות ב־Moodle',
    items: [
      {
        q: 'איזה רכיב צריך לגרור למרחב הלמידה עבור החלק הראשון?',
        a: [
          'יש לגרור ממשבצת העדכונים את הרכיב:',
          'מבחן מפמ״ר כיתה ז׳ תשפ״ו — חלק ראשון (Moodle).',
          'בהנחיות צוין שקיים סרטון הסבר לגרירת משימה למרחב. כתובת הקישור המדויקת של הסרטון עדיין לא נמסרה כאן.'
        ]
      },
      {
        q: 'האם המבחן גלוי לתלמידים מיד לאחר גרירת הרכיב?',
        a: [
          'לא. המבחן מוסתר בפני התלמידים עד שהמורה מאפשר אחרת.',
          'לכן יש לבחור את השאלות ולהכין את המבחן לפני פתיחתו לתלמידים.'
        ]
      },
      {
        q: 'כמה שאלות מופיעות בחלק הראשון וכמה מהן בוחרים?',
        a: [
      ...
      },
      {
        ...
        a: [
          ...
          'יש לבחור רק שתיים מהשאלות הללו.',
          'את השאלות שלא נבחרו יש למחוק.',
          'לאחר מכן לוחצים על "בוחן".'
        ]
      },
      {
        q: 'האם צריך לשנות את הניקוד ב־Moodle לאחר מחיקת שאלות?',
        a: [
      ...
      {
        q: 'אם שאלה נמחקה בטעות מהמשימה ב־Moodle, האם אפשר להחזיר אותה?',
        a: [
      ...
      {
        q: 'מה קורה כאשר התלמיד מגיש את החלק המתוקשב?',
        a: [
      ...
      {
        q: 'האם התלמיד מקבל ציון מיד לאחר ההגשה ב־Moodle?',
        a: [
          'לא. התלמיד לא מקבל ציון מיד עם הגשת המשימה.',
          'המורה רואה את ציוני התלמידים במרחב Moodle.'
        ]
      },
      {
        q: 'האם חייבים מחשב בחלק המתוקשב?',
        a: [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: [
          'לא. יש להשאיר רכיב זה מוסתר בפני התלמידים.',
          'החלק השני מיועד להדפסה ולביצוע בכתב, ולא לפתיחה לתלמידים כרכיב גלוי במרחב.'
        ]
      },
      {
        q: 'כמה שאלות מופיעות בקובץ החלק השני וכמה מהן התלמיד עונה?',
        a: [
      ...
      {
        q: 'מי בודק את החלק השני וכיצד הוא מנוקד?',
        a: [
  ...
  {
    id: 'special',
    title: 'פיצול המבחן, חינוך מיוחד ודחיית מועד',
    items: [
      {
      ...
      },
      {
        ...
        a: [
          'הפנייה היא להדס אייזנבך, מדריכה ארצית למתמטיקה בחטיבת הביניים.',
  ...
  },
  {
    ...
    items: [
      {
        q: 'למי פונים בבעיה הקשורה לתוכן?',
        a: [
      ...
      },
      {
        ...
        a: [
          ...
          'כתובת קישור מדויקת לתמיכה הטכנית לא נמסרה כאן.'
        ]
      },
      {
        q: 'איפה נמצאים פרטי אנשי הקשר הארציים לחט״ב?',
        a: [
          'בהנחיות הופיע סעיף "אנשי קשר ארצי חט״ב".',
          'הקישור שנמסר לפרטי הקשר הוא:',
          'https://meyda.education.gov.il/files/Pop/0files/matmatika/Chativat-Beynayim/tashpav/contact.pdf'
        ]
      },
      {
        q: 'האם יש קישור לקבוצת WhatsApp של המודל?',
        a: [
          'בהנחיות צוין שיש קישור לקבוצת WhatsApp של המודל.',
          'כתובת הקישור המדויקת של קבוצת ה־WhatsApp עדיין לא נמסרה כאן.',
          'כאשר הקישור המדויק יימסר, יש לשלב אותו בשאלה זו.'
        ]
      },
      {
        q: 'האם יש קישור לסרטון ההסבר לגרירת משימה למרחב?',
        a: [
          'בהנחיות צוין שיש סרטון הסבר לגרירת משימה למרחב.',
          'כתובת הקישור המדויקת של הסרטון עדיין לא נמסרה כאן.',
          'כאשר הקישור המדויק יימסר, יש לשלב אותו בשאלה זו או בשאלה העוסקת בגרירת רכיב המבחן ב־Moodle.'
        ]
      }
    ]
  }
...
function renderP(text){
  const terms = ['12.05.2026','01.06.2026','90 דקות','30 דקות','5 שאלות','2 שאלות מתוך 4','PDF ובקובץ Word','אפשר לפצל'];
  const cls = terms.some(t => text.includes(t)) ? ' class="highlight"' : '';
  return `<p${cls}>${linkifyUrls(htmlText(text))}</p>`;
}
