const sections = [
  ...
  { id:'moodle', title:'Moodle ושאלות טכניות', items:[
    ...
    {q:'האם יהיו טורים או טור שני למבחן המפמ״ר?', a:['לא. הקובץ לא יכלול טורים, ובשלב זה לא נראה שיהיה טור שני.']},
  ...
  { id:'makeup', title:'מועד ב׳ ועמ״ט', items:[
    ...
    {q:'האם כיתות חינוך מיוחד מחויבות להיבחן במבחן המפמ״ר?', a:['כן. כיתות חינוך מיוחד חייבות להיבחן במבחן המפמ״ר.']},
